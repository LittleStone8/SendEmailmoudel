...
//              category?category_id=10010
                urlBuilder.append("/");
                urlBuilder.append("category?category_id="+trailCategoryId);                
            }
        }
...
//    	避免分类下的二级分类会这样的url：  /ecommerce/control/category?category_id=100/category?category_id=101
        if(0 < urlBuilder.lastIndexOf("=",urlBuilder.lastIndexOf("=")-2)){
        	urlBuilder =  urlBuilder.replace( urlBuilder.lastIndexOf("=", urlBuilder.lastIndexOf("=")-1),  urlBuilder.lastIndexOf("="), "");
