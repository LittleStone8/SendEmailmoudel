...
public class PackingSessionLine implements java.io.Serializable {
    ...
    protected void issueItemToShipment(String shipmentId, String picklistBinId, GenericValue userLogin, BigDecimal quantity, LocalDispatcher dispatcher) throws GeneralException {
        ...
        GenericValue inventoryItem = delegator.findByPrimaryKey("InventoryItem", UtilMisc.toMap("inventoryItemId", this.getInventoryItemId()));
        
        issueMap.put("qoh", inventoryItem.getBigDecimal("quantityOnHandTotal").subtract(quantity));
        issueMap.put("atp", inventoryItem.getBigDecimal("availableToPromiseTotal"));
        issueMap.put("operator", userLogin.getString("userLoginId")+"("+userLogin.getString("partyId")+")");
        issueMap.put("usageType", UsageTypeEnum.OrderPacked.getName());
