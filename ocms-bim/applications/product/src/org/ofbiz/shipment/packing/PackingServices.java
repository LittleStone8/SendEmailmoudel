...
public class PackingServices {
    ...
    public static Map<String, Object> completePack(DispatchContext dctx, Map<String, ? extends Object> context) {
        ...
        if ("EMPTY".equals(shipmentId)) {
            ...
            updataOrderstatuetoPacked(dctx.getDelegator(),(String)context.get("orderId"));
        }
    ...
    public static void updataOrderstatuetoPacked(Delegator delegator,String orderId)
    {
		...
		String sql="UPDATE ORDER_HEADER SET ORDER_HEADER.STATUS_ID=\'ORDER_PACKED\' where ORDER_HEADER.ORDER_ID=\'"+orderId+"\'"; 
		try {
