...
if (action) {
   ...
   //prodView.addMemberEntity("PROD", "ProductFacility");
    //prodView.addAliasAll("PROD", null);

    prodView.addMemberEntity("PROD", "Product");
    //prodView.addViewLink("PROD", "PROD", Boolean.FALSE, ModelKeyMap.makeKeyMapList("productId"));
    ...
    if (searchInProductCategoryId) {
        ...
        prodView.addViewLink("PROD", "PRCA", Boolean.FALSE, ModelKeyMap.makeKeyMapList("productId"));
    ...
    if (productSupplierId) {
        ...
        prodView.addViewLink("PROD", "SPPR", Boolean.FALSE, ModelKeyMap.makeKeyMapList("productId"));
