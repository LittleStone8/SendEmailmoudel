        ...
        <#list shipmentRouteSegmentDatas as shipmentRouteSegmentData>
            ...
            <tr valign="middle"<#if alt_row> class="alternate-row"</#if>>
                ...
                <td>
                    ...
                    <br />
                    <span class="label">OriginFacilityName</span>
                    ...
                    <br />
                    <span class="label">${uiLabelMap.ProductDest}</span>
                    <span><#if destPostalAddress?has_content>${destPostalAddress.address1?if_exists}, ${destPostalAddress.countyGeoId?if_exists}, ${destPostalAddress.city?if_exists}, ${destPostalAddress.stateProvinceGeoId?if_exists}, <!-- ${destPostalAddress.postalCode?if_exists}, --> ${destPostalAddress.countryGeoId?if_exists}</#if> [${shipmentRouteSegment.destContactMechId?if_exists}]</span>
                    <br />
                    <!-- 
                    <span class="label">${uiLabelMap.ProductOrigin}</span>
                    ...
                    <br />
                     -->
                    <span class="label">TelecomNumber</span>
                    ...
                    <br />
                    <span class="label">TotalWeight</span>
                    <span> ${shipmentRouteSegment.billingWeight?if_exists} ${(billingWeightUom.get("description",locale))?if_exists} [${(billingWeightUom.abbreviation)?if_exists}]</span>
                    <br />
            ...
            <tr valign="middle">
                <td>&nbsp;</td>
                <#assign driverinfo = Static["org.ofbiz.shipment.shipment.ShipmentServices"].queryEGATEEdriver(delegator, shipment.driverId) />
                <td><span class="label">Driver</span> ${driverinfo.firstname?if_exists}</td>
                <td><span class="label">TEL</span> ${driverinfo.telnumber?if_exists}</td>
                <td><span class="label">License</span> ${shipment.license?if_exists}</td>
            </tr>
