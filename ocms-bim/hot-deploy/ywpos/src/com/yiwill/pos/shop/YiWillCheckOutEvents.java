 ...
 */
public class YiWillCheckOutEvents {

    public static final String module = YiWillCheckOutEvents.class.getName();
    public static final String resource = "OrderUiLabels";
    public static final String resource_error = "OrderErrorUiLabels";

    public static String cartNotEmpty(HttpServletRequest request, HttpServletResponse response) {
        YiWillCart cart = (YiWillCart) request.getSession().getAttribute("YiWillCart");
    ...
    public static String setCheckOutPages(HttpServletRequest request, HttpServletResponse response) {
        if ("error".equals(YiWillCheckOutEvents.cartNotEmpty(request, response)) == true) {
            return "error";
        }
        ...
        YiWillCart cart = (YiWillCart) session.getAttribute("YiWillCart");
        ...
        YiWillCheckOutHelper checkOutHelper = new YiWillCheckOutHelper(delegator,dispatcher,cart);
     ...
     */
    public static String determineInitialCheckOutPage(YiWillCart cart) {
    ...
    public static String createOrder(HttpServletRequest request, HttpServletResponse response) {
        HttpSession session = request.getSession();
        YiWillCart cart = YiWillCartEvents.getCartObject(request);
        LocalDispatcher dispatcher = (LocalDispatcher) request.getAttribute("dispatcher");
        Delegator delegator = (Delegator) request.getAttribute("delegator");
    ...
    public static boolean explodeOrderItems(Delegator delegator, YiWillCart cart) {
    ...
    public static String checkOrderBlacklist(HttpServletRequest request, HttpServletResponse response) {
        ...
        Delegator delegator = (Delegator) request.getAttribute("delegator");
        GenericValue userLogin = (GenericValue) session.getAttribute("userLogin");
        YiWillCheckOutHelper checkOutHelper = new YiWillCheckOutHelper(delegator, null, cart);
        String result;
    ...
    public static String checkExternalPayment(HttpServletRequest request, HttpServletResponse response) {
        ...
        YiWillCheckOutHelper checkOutHelper = new YiWillCheckOutHelper(delegator, null, null);
    ...
    private static BigDecimal determineBillingAccountAmount(String billingAccountId, String billingAccountAmount, LocalDispatcher dispatcher) {
        ...
        if (UtilValidate.isNotEmpty(billingAccountId)) {
            ...
            BigDecimal availableBalance = YiWillCheckOutHelper.availableAccountBalance(billingAccountId, dispatcher);
    ...
    public static String createReplacementOrder(HttpServletRequest request, HttpServletResponse response) {
        ...
        YiWillCartOrderReadHelper orderReadHelper = new YiWillCartOrderReadHelper(orderAdjustments, orderItems);
        ...
        List<YiWillCartItem> cartLines = cart.items();
        for (YiWillCartItem sci : cartLines) {
