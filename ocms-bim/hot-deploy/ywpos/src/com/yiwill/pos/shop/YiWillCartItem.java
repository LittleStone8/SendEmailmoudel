...
public class YiWillCartItem implements java.io.Serializable {

    public static String module = YiWillCartItem.class.getName();
    ...
    private YiWillCart.YiWillCartItemGroup itemGroup = null;
    ...
    /**
     * Makes a YiWillCartItem for a purchase order item and adds it to the cart.
     ...
     * @return a new YiWillCartItem object
     * @throws Exception
     */
    public static YiWillCartItem makePurchaseOrderItem(Integer cartLocation, String productId, BigDecimal selectedAmount, BigDecimal quantity,
            Map additionalProductFeatureAndAppls, Map attributes, String prodCatalogId, ProductConfigWrapper configWrapper, String itemType, YiWillCart.YiWillCartItemGroup itemGroup,
            LocalDispatcher dispatcher, YiWillCart cart, GenericValue supplierProduct, Timestamp shipBeforeDate, Timestamp shipAfterDate, Timestamp cancelBackOrderDate)
                throws Exception {
        ...
        YiWillCartItem newItem = new YiWillCartItem(product, additionalProductFeatureAndAppls, attributes, prodCatalogId, configWrapper, cart.getLocale(), itemType, itemGroup, null);
    ...
    /**
     * Makes a YiWillCartItem and adds it to the cart.
     * NOTE: This method will get the product entity and check to make sure it can be purchased.
     *
     * @param cartLocation The location to place this item; null will place at the end
     * @param productId The primary key of the product being added
     ...
     * @throws Exception
     */
    public static YiWillCartItem makeItem(Integer cartLocation, String productId, BigDecimal selectedAmount, BigDecimal quantity, BigDecimal unitPrice,
            ...
            String itemType, YiWillCart.YiWillCartItemGroup itemGroup, LocalDispatcher dispatcher, YiWillCart cart, Boolean triggerExternalOpsBool, Boolean triggerPriceRulesBool, String parentProductId, Boolean skipInventoryChecks, Boolean skipProductChecks)
            throws Exception {
        ...
        return makeItem(cartLocation,productId,selectedAmount,quantity,unitPrice,
                ...
                parentProductId,skipInventoryChecks,skipProductChecks,null);
    ...
    public static YiWillCartItem makeItem(Integer cartLocation, String productId, BigDecimal selectedAmount, BigDecimal quantity, BigDecimal unitPrice,
            ...
            Map additionalProductFeatureAndAppls, Map attributes, String prodCatalogId, ProductConfigWrapper configWrapper,
            String itemType, YiWillCart.YiWillCartItemGroup itemGroup, LocalDispatcher dispatcher, YiWillCart cart, Boolean triggerExternalOpsBool, Boolean triggerPriceRulesBool, String parentProductId, Boolean skipInventoryChecks, Boolean skipProductChecks,String imei)
            throws Exception {
        Delegator delegator = cart.getDelegator();
        GenericValue product = null;
        ...
        return makeItem(cartLocation, product, selectedAmount, quantity, unitPrice,
                ...
                additionalProductFeatureAndAppls, attributes, prodCatalogId, configWrapper,
                itemType, itemGroup, dispatcher, cart, triggerExternalOpsBool, triggerPriceRulesBool, parentProduct, skipInventoryChecks, skipProductChecks,imei);
    }
     ...
     * @throws Exception
     */
    public static YiWillCartItem makeItem(Integer cartLocation, GenericValue product, BigDecimal selectedAmount,
            ...
            String prodCatalogId, ProductConfigWrapper configWrapper, String itemType, YiWillCart.YiWillCartItemGroup itemGroup, LocalDispatcher dispatcher,
            YiWillCart cart, Boolean triggerExternalOpsBool, Boolean triggerPriceRulesBool, GenericValue parentProduct, Boolean skipInventoryChecks, Boolean skipProductChecks) throws Exception {
        ...
        return makeItem(cartLocation,product,selectedAmount,
               ...
               triggerExternalOpsBool,triggerPriceRulesBool,parentProduct,skipInventoryChecks,skipProductChecks,null);
    }
    ...
    */
    public static YiWillCartItem makeItem(Integer cartLocation, GenericValue product, BigDecimal selectedAmount,
            ...
            Timestamp shipBeforeDate, Timestamp shipAfterDate, Map additionalProductFeatureAndAppls, Map attributes,
            String prodCatalogId, ProductConfigWrapper configWrapper, String itemType, YiWillCart.YiWillCartItemGroup itemGroup, LocalDispatcher dispatcher,
            YiWillCart cart, Boolean triggerExternalOpsBool, Boolean triggerPriceRulesBool, GenericValue parentProduct, Boolean skipInventoryChecks, Boolean skipProductChecks,String imei) throws Exception {

        YiWillCartItem newItem = new YiWillCartItem(product, additionalProductFeatureAndAppls, attributes, prodCatalogId, configWrapper, cart.getLocale(), itemType, itemGroup, parentProduct);
    ...
    /**
     * Makes a non-product YiWillCartItem and adds it to the cart.
     ...
     * @throws Exception
     */
    public static YiWillCartItem makeItem(Integer cartLocation, String itemType, String itemDescription, String productCategoryId,
            BigDecimal basePrice, BigDecimal selectedAmount, BigDecimal quantity, Map attributes, String prodCatalogId, YiWillCart.YiWillCartItemGroup itemGroup,
            LocalDispatcher dispatcher, YiWillCart cart, Boolean triggerExternalOpsBool) throws Exception {

        Delegator delegator = cart.getDelegator();
        YiWillCartItem newItem = new YiWillCartItem(delegator, itemType, itemDescription, productCategoryId, basePrice, attributes, prodCatalogId, cart.getLocale(), itemGroup);
    ...
    /** Clone an item. */
    public YiWillCartItem(YiWillCartItem item) {
        try {
    ...
    protected YiWillCartItem() {}

    /** Creates new YiWillCartItem object. */
    protected YiWillCartItem(GenericValue product, Map additionalProductFeatureAndAppls, Map attributes, String prodCatalogId, Locale locale, String itemType, YiWillCart.YiWillCartItemGroup itemGroup) {
    ...
    /** Creates new YiWillCartItem object. */
    protected YiWillCartItem(GenericValue product, Map additionalProductFeatureAndAppls, Map attributes, String prodCatalogId, ProductConfigWrapper configWrapper, Locale locale, String itemType, YiWillCart.YiWillCartItemGroup itemGroup, GenericValue parentProduct) {
    ...
    protected YiWillCartItem(Delegator delegator, String itemTypeId, String description, String categoryId, BigDecimal basePrice, Map attributes, String prodCatalogId, Locale locale, YiWillCart.YiWillCartItemGroup itemGroup) {
    ...
    public void setQuantity(BigDecimal quantity, LocalDispatcher dispatcher, YiWillCart cart) throws Exception {
        this.setQuantity(quantity, dispatcher, cart, true);
    }

    /** Sets the quantity for the item and validates the change in quantity, etc */
    public void setQuantity(BigDecimal quantity, LocalDispatcher dispatcher, YiWillCart cart, boolean triggerExternalOps) throws Exception {
        this.setQuantity(quantity, dispatcher, cart, triggerExternalOps, true);
    }

    /** Sets the quantity for the item and validates the change in quantity, etc */
    public void setQuantity(BigDecimal quantity, LocalDispatcher dispatcher, YiWillCart cart, boolean triggerExternalOps, boolean resetShipGroup) throws Exception {
        this.setQuantity(quantity, dispatcher, cart, triggerExternalOps, resetShipGroup, true, false);
    }

    /** Sets the quantity for the item and validates the change in quantity, etc */
    public void setQuantity(BigDecimal quantity, LocalDispatcher dispatcher, YiWillCart cart, boolean triggerExternalOps, boolean resetShipGroup, boolean updateProductPrice) throws Exception {
    ...
    public static String checkAvailability(String productId, BigDecimal quantity, Timestamp reservStart, BigDecimal reservLength, YiWillCart cart) {
        Delegator delegator = cart.getDelegator();
    ...
    protected boolean isInventoryAvailableOrNotRequired(BigDecimal quantity, String productStoreId, LocalDispatcher dispatcher) throws Exception {
        ...
        try {
            ...
            if (ServiceUtil.isError(invReqResult)) {
                ...
                throw new Exception((String) invReqResult.get(ModelService.ERROR_MESSAGE));
            }
    ...
    protected void setQuantity(BigDecimal quantity, LocalDispatcher dispatcher, YiWillCart cart, boolean triggerExternalOps, boolean resetShipGroup, boolean updateProductPrice, boolean skipInventoryChecks) throws Exception {
...
//        }
        ...
        if (resetShipGroup) {
            ...
            // Deprecated in favour of YiWillCart.createDropShipGroups(), called during checkout
                    ...
                    try {
                        ...
                        if (supplierProduct != null) {
                            ...
                            for(int i = 0; i < shipGroups.size(); i++) {
                                YiWillCart.CartShipInfo csi = (YiWillCart.CartShipInfo)shipGroups.get(i);
    ...
    public void updatePrice(LocalDispatcher dispatcher, YiWillCart cart) throws Exception {
            ...
            try {
                ...
                if (cart.getOrderType().equals("PURCHASE_ORDER")) {
                    ...
                    if (ServiceUtil.isError(priceResult)) {
                        throw new Exception("There was an error while calculating the price: " + ServiceUtil.getErrorMessage(priceResult));
                    }
                    Boolean validPriceFound = (Boolean) priceResult.get("validPriceFound");
                    if (!validPriceFound.booleanValue()) {
                        throw new Exception("Could not find a valid price for the product with ID [" + this.getProductId() + "] and supplier with ID [" + partyId + "], not adding to cart.");
                    }
                    
                    BigDecimal price =  (BigDecimal) priceResult.get("price");
                    
                    if(price.compareTo(BigDecimal.ZERO) <= 0){
                    	throw new Exception("Could not find a valid price for the product with ID [" + this.getProductId() + "]");
                    }
                    ...
                    if (Boolean.FALSE.equals(validPriceFound)) {
                        throw new Exception("Could not find a valid price for the product with Currency [" + cart.getCurrency() + "] and ID [" + this.getProductId() + "], not adding to cart.");
                    }
                    ...
                    if (ServiceUtil.isError(recurringPriceResult)) {
                        throw new Exception("There was an error while calculating the price: " + ServiceUtil.getErrorMessage(recurringPriceResult));
                    }
                ...
                throw new Exception("There was an error while calculating the price", e);
            }
        }
    }
    ...
    /** Sets the item group. */
    public void setItemGroup(YiWillCart.YiWillCartItemGroup itemGroup) {
        this.itemGroup = itemGroup;
    }

    /** Sets the item group. */
    public void setItemGroup(String groupNumber, YiWillCart cart) {
        this.itemGroup = cart.getItemGroupByNumber(groupNumber);
    }

    /** Returns the item group. */
    public YiWillCart.YiWillCartItemGroup getItemGroup() {
...
//          String orderItemSeqId = UtilFormatOut.formatPaddedNumber(nextItemSeq, 5);
        setOrderItemSeqId(orderItemSeqId);
   ...
   public List getFeaturesForSupplier(LocalDispatcher dispatcher,String partyId) {
    ...
    public BigDecimal getOtherAdjustments() {
        return YiWillCartOrderReadHelper.calcItemAdjustments(quantity, getBasePrice(), this.getAdjustments(), true, false, false, false, false);
    }

    /** Returns the "other" adjustments. */
    public BigDecimal getOtherAdjustmentsRecurring() {
        return YiWillCartOrderReadHelper.calcItemAdjustmentsRecurringBd(quantity, getRecurringBasePrice() == null ? BigDecimal.ZERO : getRecurringBasePrice(), this.getAdjustments(), true, false, false, false, false);
    }
...
//        Debug.logInfo("Price" + getBasePrice() + " quantity" +  quantity + " Rental adj:" + getRentalAdjustment() + " other adj:" + getOtherAdjustments(), module);
    ...
    public boolean equals(YiWillCartItem item) {
    ...
    public boolean equals(String productId, Map additionalProductFeatureAndAppls, Map attributes, String prodCatalogId, ProductConfigWrapper configWrapper, String itemType, YiWillCart.YiWillCartItemGroup itemGroup, BigDecimal selectedAmount) {
    ...
    public boolean equals(String productId, Timestamp reservStart, BigDecimal reservLength, BigDecimal reservPersons, Map additionalProductFeatureAndAppls, Map attributes, String prodCatalogId, ProductConfigWrapper configWrapper, String itemType, YiWillCart.YiWillCartItemGroup itemGroup, BigDecimal selectedAmount) {
    ...
    /** Compares the specified object with this cart item. Defaults isPromo to false. */
    public boolean equals(String productId, Map additionalProductFeatureAndAppls, Map attributes, String prodCatalogId, BigDecimal selectedAmount, String itemType, YiWillCart.YiWillCartItemGroup itemGroup, boolean isPromo) {
    ...
    public boolean baseEquals(String productId,  boolean isPromo) {
    ...
    public boolean equals(String productId, Timestamp reservStart, BigDecimal reservLength, BigDecimal reservPersons, String accommodationMapId, String accommodationSpotId,
            ...
            ProductConfigWrapper configWrapper, String itemType, YiWillCart.YiWillCartItemGroup itemGroup, boolean isPromo) {
        if (this.productId == null || productId == null) {
    ...
    public Delegator getDelegator() {
        if (delegator == null) {
            if (UtilValidate.isEmpty(delegatorName)) {
                throw new IllegalStateException("No delegator or delegatorName on YiWillCartItem, somehow was not setup right.");
            }
    ...
    public void explodeItem(YiWillCart cart, LocalDispatcher dispatcher) throws Exception {
        ...
        if (baseQuantity.compareTo(BigDecimal.ONE) > 1) {
            for (int i = 1; i < baseQuantity.intValue(); i++) {
                // clone the item
                YiWillCartItem item = new YiWillCartItem(this);
            ...
            while (newItemsItr.hasNext()) {
                cart.addItem(thisIndex, (YiWillCartItem) newItemsItr.next());
            }
        }
    }
