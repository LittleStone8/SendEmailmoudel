 ...
 * 
 */
public class ReportSecurity extends BaseStoreSecurity {
	
	protected ReportSecurity() {
	}

	public ReportSecurity(Delegator delegator) {
	...
	public Map<String, String> getAvailableSGAndRoleType(Iterator<GenericValue> iterator) {
		...
		while (iterator.hasNext()) {
			...
			if (userGroupID.equals(BANANA_SINGLE)) {
				if (!conditions.containsKey("BANANA_S")) {
					conditions.put("BANANA_S", "single");
				}
			}
