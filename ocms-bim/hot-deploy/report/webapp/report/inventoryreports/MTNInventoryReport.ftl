		...
		<div class="inventory_report_content">
			<div class="inventory_report_search">
				...
				<div class="inventory_report_condition">
					<form class="search_form" id="search_form" action="/report/control/ExportOperatorInventoryReport">
	...
	$(document).ready(function(){
		...
		function LookupInventoryReport(options, target){
			...
			$.ajax({
		        type: 'post',
		        dataType: 'json',
		        url: '/report/control/LookupInventoryReport_MTNINV',
		        data: {
    	...
    	function initSGroup(){
    	  	jQuery.ajax({
        		...
        		url: '/report/control/SearchAvailableStoresAndSGroups_MTNINV',
    	  		success: function (data) {
    	  			if(data.responseMessage=="success"){
