...
<@frameSectionHeader title="The salesman" extra=extraOptions/>

<table class="crmsfaListTable">
  <tbody>
    <tr class="crmsfaListTableHeader">
      <td class="tableheadtext" >FirstName</td>
      <td class="tableheadtext" >MiddleName</td>
      <td class="tableheadtext" >LastName</td>
