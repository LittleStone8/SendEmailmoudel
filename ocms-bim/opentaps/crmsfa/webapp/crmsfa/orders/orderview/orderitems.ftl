...
<#-- 订单Create As New Order报错 暂时隐藏		chenshihua 		2017-6-26-->
<#--  
<#assign newOrderLink><a href="<@ofbizUrl>/ordermgr/control/new_gwtSuggestProductForCart?${paramString}&finalizeMode=init</@ofbizUrl>" class="subMenuButton">${uiLabelMap.OrderCreateAsNewOrder}</a></#assign>
...
<div class="subMenuBar" style="margin-bottom:5px"><a href="<@ofbizUrl>ExportOrderInfo?${paramString}&finalizeMode=init&ordertotal=${order.total}</@ofbizUrl>" class="subMenuButton">Export</a></div>
...
<@flexAreaClassic targetId="orderItems" title=uiLabelMap.OrderOrderItems defaultState="open" headerContent=itemLinks style="margin:0">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr align="left" valign="bottom">
      ...
      <td width="20%" align="left"><div class="tableheadtext">IMEI</div></td>
      <td width="10%" align="left"><div class="tableheadtext">${uiLabelMap.OrderQuantity}</div></td>
      <td width="15%" align="left"><div class="tableheadtext">${uiLabelMap.OrderUnitList}</div></td>
      <td width="15%" align="left"><div class="tableheadtext">${uiLabelMap.OrderAdjustments}</div></td>
      <td width="20%" align="left"><div class="tableheadtext">${uiLabelMap.OrderSubTotal}</div></td>
    </tr>
    <#if !order.items?has_content>
      <tr><td colspan="5"><font color="red">${uiLabelMap.checkhelper_sales_order_lines_lookup_failed}</font></td></tr>
    <#else>
      ...
      <script type="text/javascript">
       ...
       <#if !(item.isPromo() && item.isCancelled())>
        ...
        <tr>
          ...
          <#else>
                ...
                <#if !returnItem.return.isCancelled()>
                  <div class="tabletext">
                    <font color="red"><b>${uiLabelMap.OrderReturned}</b></font> #<a href="<@ofbizUrl>viewReturn?returnId=${returnItem.returnId}</@ofbizUrl>" class="linktext">${returnItem.returnId}</a>
                        ...
                        <#-- QUANTITY -->
            <td  colspan="1" align="left" valign="top" nowrap="nowrap">
              <table>
                <tr valign="top">
                  <td>    
                  <#assign itemimei = Static["org.opentaps.common.product.UtilProduct"].finimeibyitem(delegator, item.shipGroupInventoryReservations)/>
                    <div class="tabletext">${itemimei}</div>
                  </td>
                </tr>
              </table>
            </td>
            ...
            <#-- 
             ...
             -->
             <div class="tabletext"><@ofbizCurrency amount=item.unitPrice isoCode=order.currencyUom/><#if item.unitListPrice?has_content></#if></div>
            
             </td>
            <#-- 调整价格	chenshhua	2017-6-7 -->
            <td align="left" valign="top" nowrap="nowrap">
              <div class="adjustmentBox"><span class="otherAdjustmentsCurrencyUom"></span>&nbsp;&nbsp;</div>
            </td>
            <#-- 
        ...
        <#if item.isPhysical() && item.shipAfterDate?exists>
          <tr>
            <td align="right" colspan="4">
              <div class="tabletext" style="font-size: xx-small;"><b><i>${uiLabelMap.OrderShipAfterDate}</i>:</b></div>
            </td>
            <td align="center">${getLocalizedDate(item.shipAfterDate, "DATE")}</td>
          </tr>
        </#if>
        <#if item.shipBeforeDate?exists>
          <tr>
            <td align="right" colspan="4">
              <div class="tabletext" style="font-size: xx-small;"><b><i>${uiLabelMap.OrderShipBeforeDate}</i>:</b></div>
            </td>
            <td align="center">${getLocalizedDate(item.shipBeforeDate, "DATE")}</td>
          </tr>
        </#if>
...
<#--               <td class="tabletext">
    ...
    <@sectionSepBar />
    <tr>
      <td align="right" colspan="4"><div class="tabletext"><b>${uiLabelMap.OrderItemsSubTotal}</b></div></td>
      <td align="center" nowrap="nowrap"><div class="tabletext"><@ofbizCurrency amount=order.itemsSubTotal isoCode=order.currencyUom/></div></td>
    </tr>
    <#-- tax adjustments -->
    <tr>
      <td align="right" colspan="4"><div class="tabletext"><b>${uiLabelMap.OrderTotalSalesTax}</b></div></td>
      <td align="center" nowrap="nowrap"><div class="tabletext"><@ofbizCurrency amount=order.taxAmount isoCode=order.currencyUom/></div></td>
    </tr>
    ...
    <tr>
      ...
      <td align="center" nowrap="nowrap"><div class="tabletext"><@ofbizCurrency amount=order.shippingAmount isoCode=order.currencyUom/></div></td>
    </tr>
    ...
    <tr>
      <td align="right" colspan="4"><div class="tabletext"><b>${uiLabelMap.OrderTotalOtherOrderAdjustments}</b></div></td>
      <#-- 
      <td align="center" nowrap="nowrap"><div class="tabletext"><@ofbizCurrency amount=order.otherAdjustmentsAmount isoCode=order.currencyUom/></div></td>
        -->
      <td align="center" nowrap="nowrap"><div class="tabletext"><span class="otherAdjustmentsCurrencyUom"></span>&nbsp;&nbsp;<span class="orderTotalOtherOrderAdjustments"></div></span></td>
    </tr>
   

    <#-- grand total -->
    <tr>
      <td align="right" colspan="4"><div class="tabletext"><b>${uiLabelMap.OrderOrderTotal}</b></div></td>
      <td align="center" nowrap="nowrap">
        <div class="tabletext"><@ofbizCurrency amount=order.total isoCode=order.currencyUom/></div>
      </td>
    </tr>
    <#-- <tr>
      <td align="right" colspan="4"><div class="tabletext"><b>${uiLabelMap.OrderTotalDue}</b></div></td>
      <td align="center" nowrap="nowrap">
