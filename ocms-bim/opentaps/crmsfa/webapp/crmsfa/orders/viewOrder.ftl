...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="50%" valign="top">
    	<@include location="component://crmsfa/webapp/crmsfa/content/shipping.ftl"/>
     <#--  隐藏Ship Group chenshihua	2017-6-7
...
<#--  
<div style="margin-bottom:15px">
  <@include location="component://crmsfa/webapp/crmsfa/content/Customercontent.ftl"/>
</div>
-->
<div style="margin-bottom:15px">
  <@include location="component://crmsfa/webapp/crmsfa/content/salesmancontent.ftl"/>
</div>


<#if isNeedShip =="Y">
<div style="margin-bottom:15px">
  <@include location="component://crmsfa/webapp/crmsfa/content/Shipmentcontent.ftl"/>
</div>
</#if>
<!-- <div style="margin-bottom:15px">
  <#include "orderview/orderemails.ftl"/>
</div> -->
<@include location="component://crmsfa/webapp/crmsfa/content/additionalcontent.ftl"/>
