...
import org.opentaps.gwt.common.client.suggest.IsFixOrderAutocomplete;
...
import org.opentaps.gwt.common.client.suggest.PaymentWay;
...
import org.opentaps.gwt.common.client.suggest.ShipmentAutocomplete;
...
public class FindOrdersForm extends FindEntityForm<SalesOrderListView> {
 ...
 //   private final TextField orderNameInput;
    ...
    //Shipment
    private final ShipmentAutocomplete shipmentInput;
    //is fix order
    private final IsFixOrderAutocomplete isFixOrderInput;
    //Shipment
    private final PaymentWay paymentWayInput;
    // PO #
   ...
   // private final TextField serialNumberInput;
    ...
    //    orderNameInput = new TextField(UtilUi.MSG.orderOrderName(), "orderName", getInputLength());
        ...
        shipmentInput = new ShipmentAutocomplete(UtilUi.MSG.shipment(),"shipment",getInputLength());
        paymentWayInput = new PaymentWay(UtilUi.MSG.paymentWay(), "paymentWay", getInputLength());
  ...
  //      createdByInput = new TextField(UtilUi.MSG.commonCreatedBy(), "createdBy", getInputLength());
   ...
   //     serialNumberInput = new TextField(UtilUi.MSG.productSerialNumber(), "serialNumber", getInputLength());
        ...
        //is fix order
        isFixOrderInput = new IsFixOrderAutocomplete(UtilUi.MSG.isFixOrder(),"isFixOrder",getInputLength());
        
        findAllInput = new CheckboxField("Search All", "Search All");
        findAllInput.setValue(true);
        ...
        filterPanel = getMainForm().addTab("Search Orders");
...
//        columnOnePanel.addField(correspondingPoIdInput);
 //       columnTwoPanel.addField(orderNameInput);
        ...
        columnTwoPanel.addField(shipmentInput);
       ...
       // columnTwoPanel.add(UtilUi.makeBlankFormCell());
        ...
        columnTwoPanel.addField(paymentWayInput);
       // columnTwoPanel.add(UtilUi.makeBlankFormCell());

//        columnOnePanel.addField(lotInput);
        columnOnePanel.addField(isFixOrderInput);
...
//        columnOnePanel.addField(createdByInput);
     ...
     */
    public FindOrdersForm(boolean autoLoad,Integer num) {
        super(UtilUi.MSG.crmFindOrders());
...
//        columnOnePanel.addField(createdByInput);
    ...
    @Override protected void filter() {
       ...
       //     getListView().filterByOrderName(orderNameInput.getText());
            ...
            getListView().filterByShipment(shipmentInput.getText());
            getListView().filterByPaymentWay(paymentWayInput.getText());
            getListView().filterByIsFixOrder(isFixOrderInput.getText());
