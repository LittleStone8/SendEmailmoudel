...
public class Entry extends BaseEntry {
    ...
    private static final String FIND_WAREHOUSE_ORDERS_ID = "findWarehouseOrders";
    ...
    private void loadOrdersWidgets() {
        ...
        if (RootPanel.get(FIND_WAREHOUSE_ORDERS_ID) != null) {
        	loadFindWarehouseOrders();
        }
    ...
    private void loadFindWarehouseOrders() {
        findOrdersForm = new FindOrdersForm(false,1);
        RootPanel.get(FIND_WAREHOUSE_ORDERS_ID).add(findOrdersForm.getMainPanel());
    }
