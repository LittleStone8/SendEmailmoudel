...
public class OrderViewForListing extends Entity {
    ...
    public void calculateExtraFields(Delegator delegator, TimeZone timeZone, Locale locale) throws RepositoryException {
        ...
        if (getStatusId() != null) {
            try {
                ...
                String statusDescription = (String) status.get(StatusItem.Fields.description.name(), locale);
    ...
    /**
     * Sets the formatted Is Fix Order.
     * @param orderNameId the formatted Is Fix Order
     */
    ...
    /**
     * Gets the formatted Is Fix Order.
     * @return the formatted Is Fix Order
     */
    ...
    public Map<String, Object> toMap() {
        ...
        mapValue.put("isFixOrder", getIsFixOrder());
        return mapValue;
    }
    ...
    public void fromMap(Map<String, Object> mapValue) {
        ...
        setStorName((String) mapValue.get("storeName"));
        ...
        setIsFixOrder((String) mapValue.get("isFixOrder"));
    }
}
