...
public class Order extends org.opentaps.base.entities.OrderHeader {
	...
	/**
	 * Get the specification object which contains enumerations and logical
	 * checking for Orders.
	 * 
	...
	public Boolean isShipped() {
		return getOrderSpecification().isShipped(this);
	}

	/**
	 * Checks if this order has paied or not;
	 * 
	 * @return a <code>Boolean</code> value
	 */
	public Boolean isPayment() {
		return getOrderSpecification().isPayment(this);
	}
	...
	public Boolean isNeedShipment() throws RepositoryException {
		String needShipment = getRepository().getNeedShipment(this);
		if ("Y".equals(needShipment)) {
			return true;
		}
		return false;
	}
	public Boolean ispacked() throws RepositoryException {
		String ispack = getRepository().ispacked(this);
		if ("Y".equals(ispack)) {
			return true;
		}
		return false;
	...
	public Boolean isChargeOrder() throws RepositoryException {
		String ispack = getRepository().isChargeOrder(this);
		if ("Y".equals(ispack)) {
			return true;
		}
		return false;
	}
	public Boolean istoday() throws RepositoryException {
		String istoday = getRepository().istoday(this);
		if ("Y".equals(istoday)) {
			return true;
		}
		return false;
	}
	public Boolean is30day() throws RepositoryException {
		String is30day = getRepository().is30day(this);
		if ("Y".equals(is30day)) {
			return true;
		}
		return false;
	}
	public Boolean iscash() throws RepositoryException {
		String iscash = getRepository().iscash(this);
		if ("Y".equals(iscash)) {
			return true;
		}
		return false;
	}
	public String getOrderStroe() throws RepositoryException {
		return   getRepository().getOrderStroe(this);
	
	}
	
	/**
	 * Gets this order <code>OrderType</code>. This is an alias for
	 * {@link org.opentaps.base.entities.OrderHeader#getOrderType}.
	 * 
	...
	/**
	 * Gets the sales channel for this order. This is an alias for
	 * {@link org.opentaps.base.entities.OrderHeader#getSalesChannelEnumeration}.
	 * 
	...
	/**
	 * Gets the product store for this order. Returns the order domain object
	 * instead of the base entity.
	 * 
	 ...
	 * returns from the list. Otherwise it fetches the item directly from the
	 * persistence layer.
	 * 
	 * @param orderItemSeqId
	 *            The line item sequence number of the order item
	 * @return OrderItem
	 * @throws RepositoryException
	 *             if an error occurs
	...
	public OrderItem getOrderItem(String orderItemSeqId) throws RepositoryException, EntityNotFoundException {
		if (orderItems != null) {
			...
			// TODO these exceptions should be constructed on the basis of
			// Entity.class and the pk.
	...
	/**
	 * Gets the <code>OrderItems</code> for this order, ordered by
	 * orderItemSeqId. Returns the order domain object instead of the base
	 * entity.
	 * 
	...
	public List<OrderItem> getOrderItems() throws RepositoryException {
		if (orderItems == null) {
			orderItems = getRelated(OrderItem.class, "OrderItem",
					Arrays.asList(OrderItem.Fields.orderItemSeqId.name()));
		}
		return orderItems;
	}
	...
	/**
	 * Gets the <code>OrderItems</code> for this order, ordered by
	 * orderItemSeqId. This is an alias for {@link #getOrderItems}.
	 * 
	 * @return the list of <code>OrderItem</code>
	 * @throws RepositoryException
	 *             if an error occurs
	...
	/**
	 * Gets the <code>OrderItems</code> for this order that are promotions,
	 * ordered by orderItemSeqId.
	 * 
	 * @return the list of <code>OrderItem</code>
	 * @throws RepositoryException
	 *             if an error occurs
	...
	/**
	 * Gets the <code>ReturnItems</code> for this order. Returns the order
	 * domain object instead of the base entity.
	 * 
	...
	/**
	 * Gets the <code>OrderItems</code> for this order that are still valid (not
	...
	/**
	 * Gets the <code>OrderItems</code> for this order that are still valid (not
	 * cancelled or rejected) and in the given <code>OrderItemShipGroup</code>.
	 * 
	 * @param shipGroup
	 *            the <code>OrderItemShipGroup</code> to get the items from
	 * @return list of valid <code>OrderItem</code>
	 * @throws RepositoryException
	 *             if an error occurs
	 */
	...
	/**
	 * Get the <code>OrderItems</code> for this order that are still valid (not
	 * cancelled or rejected) and for which the ordered quantity is not zero.
	 * 
	 * @return list of valid <code>OrderItem</code> where ordered quantity is
	 *         not zero.
	 * @throws RepositoryException
	 *             if an error occurs
	 * @see #getValidItems
	...
	/**
	 * Gets the non physical <code>OrderItems</code> for this order that have
	 * the given status.
	 * 
	 * @param statusId
	 *            status for the <code>OrderItems</code> to return
	 * @return list of <code>OrderItem</code> that are not physical products and
	...
	/**
	 * Gets the payment preferences for this order. Returns the order domain
	 * object instead of the base entity.
	 * 
	...
	/**
	 * Gets the payment preferences for this order. This is an alias for
	 * {@link #getOrderPaymentPreferences}.
	 * 
	 * @return list of <code>OrderPaymentPreference</code>
	 * @throws RepositoryException
	 *             if an error occurs
	 ...
	 *            a <code>String</code> ID of the ship group
	...
	/**
	 * Gets the order item ship groups for this order. Returns the order domain
	 * object instead of the base entity.
	 * 
	...
	/**
	 * Gets the order item ship groups for this order. This is an alias for
	 * {@link #getOrderItemShipGroups}.
	 * 
	 * @return list of <code>OrderItemShipGroup</code>
	 * @throws RepositoryException
	 *             if an error occurs
	...
	/**
	 * Gets the notes for this order ordered from most recent to oldest. This is
	 * an alias for {@link #getOrderHeaderNoteViews}.
	 * 
	 * @return list of <code>OrderHeaderNoteView</code>
	 * @throws RepositoryException
	 *             if an error occurs
	...
	/**
	 * Gets the adjustments for this order. Returns the order domain object
	 * instead of the base entity.
	 * 
	...
	/**
	 * Gets the adjustments for this order. This is an alias for
	 * {@link #getOrderAdjustments}.
	 * 
	 * @return list of <code>OrderAdjustment</code>
	 * @throws RepositoryException
	 *             if an error occurs
	...
	/**
	 * Gets the adjustments for this order that are not related to an order
	 * item. This return adjustments that are global to this order such as
	 * shipping charge, global promotion, etc ...
	 * 
	 * @return sub list of <code>OrderAdjustment</code> that are not related to
	 *         an order item
	 * @throws RepositoryException
	 *             if an error occurs
	...
	/**
	 * Gets the total value of all order adjustments not related to a particular
	 * order item.
	 * 
	 * @return the total value of all order adjustments not related to a
	...
	/**
	 * Gets the total value of order adjustments not related to a particular
	 * order item which have been invoiced.
	 * 
	 * @return the total value of order adjustments not related to a particular
	 *         order item which have been invoiced
	 * @throws RepositoryException
	 *             if an error occurs
	 */
	...
	/**
	 * Gets the total value of order adjustments not related to a particular
	 * order item which have not been invoiced.
	 * 
	 * @return the total value of order adjustments not related to a particular
	 *         order item which have not been invoiced
	 * @throws RepositoryException
	...
	/**
	 * Gets the shipping adjustments for this order that are not related to an
	 * order item.
	 * 
	 * @return sub list of the order shipping <code>OrderAdjustment</code> that
	 *         are not related to an order item
	 * @throws RepositoryException
	 *             if an error occurs
	 * @see #getOrderAdjustments
	...
	/**
	 * Gets the non shipping adjustments for this order that are not related to
	 * an order item.
	 * 
	 * @return sub list of the <code>OrderAdjustment</code> other than shipping
	 *         and that are not related to an order item
	 * @throws RepositoryException
	 *             if an error occurs
	 * @see #getOrderAdjustments
	 * @see #getNonItemAdjustments
	...
	/**
	 * Gets the order statuses for this order. This list describe the history of
	 * status this order went through, with the current status being the first
	 * of the list. This overrides
	 * {@link org.opentaps.base.entities.OrderHeader#getOrderStatuses} to
	 * specify the ordering.
	 * 
	 * @return list of <code>OrderStatus</code> from current to oldest, that
	 *         relate this order to a <code>StatusItem</code>
	 * @throws RepositoryException
	 *             if an error occurs
	 */
	@Override
	...
	/**
	 * Gets this order current <code>StatusItem</code>. This is an alias for
	 * {@link org.opentaps.base.entities.OrderHeader#getStatusItem}.
	 * 
	...
	/**
	 * Gets this order current <code>OrderStatus</code>. To get the current
	 * <code>StatusItem</code> use {@link #getStatus} instead
	 * 
	 * @return the current <code>OrderStatus</code>, that relate the order to
	 *         its current <code>StatusItem</code>
	 * @throws RepositoryException
	 *             if an error occurs
	 */
	...
	/**
	 * Gets the terms for this order. This is an alias for
	 * {@link org.opentaps.base.entities.OrderHeader#getOrderTerms}.
	 * 
	 ...
	 * 
	 * @return 0 if no billing account is related, else the maximum of all
	 *         <code>OrderPaymentPreferences</code> maxAmount for the billing
	 *         account
	 * @throws RepositoryException
	 *             if an error occurs
	 ...
	 * 
	 * @return the earliest ship by date from all
	 *         <code>OrderItemShipGroup</code>, or null if no date was found
	 * @throws RepositoryException
	 *             if an error occurs
	 */
	...
	/**
	 * Returns the correct organization party of the order, depending on type of
	...
	public OrderRole getPlacingCustomerOrderRole() throws RepositoryException {
		if (placingCustomerOrderRole == null) {
			placingCustomerOrderRole = getRepository().getRelatedOrderRoleByTypeId(this,
					getOrderSpecification().placingCustomerRoleTypeIds());
		}
	...
	public OrderRole getBillToCustomerOrderRole() throws RepositoryException {
		if (billToCustomerOrderRole == null) {
			billToCustomerOrderRole = getRepository().getRelatedOrderRoleByTypeId(this,
					getOrderSpecification().billToCustomerRoleTypeIds());
		}
	...
	public OrderRole getBillFromVendorOrderRole() throws RepositoryException {
		if (billFromVendorOrderRole == null) {
			billFromVendorOrderRole = getRepository().getRelatedOrderRoleByTypeId(this,
					getOrderSpecification().billFromVendorRoleTypeIds());
		}
	...
	public OrderRole getSupplierAgentOrderRole() throws RepositoryException {
		if (supplierAgentOrderRole == null) {
			supplierAgentOrderRole = getRepository().getRelatedOrderRoleByTypeId(this,
					getOrderSpecification().supplierAgentRoleTypeIds());
		}
	...
	public OrderRole getShipToCustomerOrderRole() throws RepositoryException {
		if (shipToCustomerOrderRole == null) {
			shipToCustomerOrderRole = getRepository().getRelatedOrderRoleByTypeId(this,
					getOrderSpecification().shipToCustomerRoleTypeIds());
		}
	...
	public OrderRole getDistributorOrderRole() throws RepositoryException {
		if (distributorOrderRole == null) {
			distributorOrderRole = getRepository().getRelatedOrderRoleByTypeId(this,
					getOrderSpecification().distributorRoleTypeIds());
		}
	...
	public OrderRole getAffiliateOrderRole() throws RepositoryException {
		if (affiliateOrderRole == null) {
			affiliateOrderRole = getRepository().getRelatedOrderRoleByTypeId(this,
					getOrderSpecification().affiliateRoleTypeIds());
		}
	 ...
	 * 
	 * @return the <code>Party</code> for the "supplier agent" in case of a
	 *         Purchase Order, or the "placing customer" for a Sales Order
	 * @throws RepositoryException
	 *             if an error occurs
	 */
	...
	public List<Party> getCommissionAgents() throws RepositoryException {
		List<OrderRole> roles = getRepository().getRelatedOrderRolesByTypeId(this,
				getOrderSpecification().commissionAgentRoleTypeIds());
	...
	/**
	 * Gets the list of <code>TelecomNumber</code> associated to this order and
	 * to the main external party.
	 * 
	...
	/**
	 * Gets the list of <code>ContactMechPurposeType</code> for the given
	 * <code>ContactMech</code> from this order and the main external party.
	 * 
	 * @param contactMech
	 *            a <code>ContactMech</code>
	 * @return a list of <code>ContactMechPurposeType</code>
	 * @throws RepositoryException
	 *             if an error occurs
	 * @see #getOrderAndMainExternalPartyPhoneNumbers
	 */
	public List<ContactMechPurposeType> getContactMechPurposeTypesForContactMech(ContactMech contactMech)
			throws RepositoryException {
	 ...
	 * 
	 * @return the list of <code>PostalAddress</code> associated to this order
	 *         origin <code>Facility</code> that has a shipping origin purpose
	 * @throws RepositoryException
	 *             if an error occurs
	 */
	 ...
	 * 
	 * @return the list of <code>PostalAddress</code> associated to the order
	 *         that has a shipping purpose
	 * @throws RepositoryException
	 *             if an error occurs
	 */
	...
	public BigDecimal getItemsSubTotal_() throws RepositoryException {
		if (itemsSubTotal != null) {
			return itemsSubTotal;
		}
	...
	/**
	 * Gets the total amount of the non item order adjustments that are neither
	 * shipping charges nor tax related for this order. For the two other
	 * categories of non item adjustments, see {@link #getShippingAmount} and
	 * {@link #getTaxAmount} respectively
	 * 
	 ...
	 * For the two other categories of non item adjustments, see
	 * {@link #getOtherAdjustmentsAmount} and {@link #getTaxAmount}
	 * respectively.
	 * 
	 ...
	 * 
	 * @return the total amount for the order sales tax excluding items sales
	 *         tax
	 * @exception RepositoryException
	 *                if an error occurs
	 * @see #getTaxAmount
	...
	/**
	 * Gets the total amount of tax adjustments for this order. For tax amount
	 * not including the items taxes, see {@link #getGlobalTaxAmount}.
	 * 
	...
	/**
	 * Gets the total amount for this order. This is the sum of:
	 * <ul>
	 ...
	 * 
	 * @return the order total minus sum of all payments, net of refunds, for
	 *         this order
	 * @throws RepositoryException
	 *             if an error occurs
	 */
	...
	/**
	 * Gets the amount of received and pending payments for this order. This is
	 * used to manage the order payment preferences.
	 * 
	 * @return the order total minus sum of all received and pending order
	...
	/**
	 * Finds the returnable <code>OrderItem</code> for to the given
	 * <code>Order</code>. The return info map associated to the
	 * <code>OrderItem</code> contains: - returnableQuantity - returnablePrice -
	 * itemTypeKey (the product type if applicable, else the order item type)
	 * 
	 * @return a <code>Map</code> associating the returnable
	 *         <code>OrderItem</code> and a return info <code>Map</code>
	 * @throws RepositoryException
	 *             if an error occurs
