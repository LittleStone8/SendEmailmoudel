...
public abstract class SalesOrderLookupConfiguration {
    ...
    public static final String URL_FIND_WAREHOUSE_ORDERS = "gwtFindSalesOrders";
    ...
    //shipment
    public static final String URL_SHIPMENT = "gwtSearchShipment";
    //payment way
    public static final String URL_ISFIXORDER = "gwtSearchIsFixOrder";
    public static final String IN_IS_FIX_ORDER = "isFixOrder";
    public static final String URL_PAYMENTWAY = "gwtSearchPaymentWay";
    ...
    public static final String IN_PRODUCT_STORE_NAME = "storeName";
    
    public static final String INOUT_STATUS_ID = "statusId";
    public static final String INOUT_SHIPMENT = "shipment";
    public static final String INOUT_PAYMENTWAY = "paymentWay";
