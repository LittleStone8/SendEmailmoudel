...
public class SalesOrderListView extends EntityListView {
    ...
    public void init(int i) {
        init(SalesOrderLookupConfiguration.URL_FIND_WAREHOUSE_ORDERS, "/warehouse/control/orderview?orderId={0}", UtilUi.MSG.orderOrderId());
    }
    /**
    ...
    protected void init(String entityFindUrl, String entityViewUrl, String idLabel) {
	    ...
	    public String render(Object value, CellMetadata cellMetadata, Record record, int rowIndex, int colNum,
		  ...
		  if (value == null) {
                  ...
                  return Format.format("<a class=\"linktext\" target=\"_blank\" href=\"/crmsfa/control/orderview?orderId={0}\">{1}</a>", record.getAsString(SalesOrderLookupConfiguration.INOUT_ORDER_ID) , (String) value);
	    }
	}; 
        
        columnOrderNameId.setRenderer(renderer);
       ...
       /* ColumnConfig columnCorrespondingPoId = makeColumn(UtilUi.MSG.opentapsPONumber(), new StringFieldDef(SalesOrderLookupConfiguration.INOUT_CORRESPONDING_PO_ID));
        ...
        ColumnConfig columnProductStoreName = makeColumn(UtilUi.MSG.productStoreName(), new StringFieldDef(SalesOrderLookupConfiguration.IN_PRODUCT_STORE_NAME));
        columnProductStoreName.setWidth(100);
        
        ColumnConfig columnIsFixOrder = makeColumn(UtilUi.MSG.isFixOrder(), new StringFieldDef(SalesOrderLookupConfiguration.IN_IS_FIX_ORDER));
        columnIsFixOrder.setWidth(100);
    ...
    public void filterByShipment(String shipment) {
        setFilter(SalesOrderLookupConfiguration.INOUT_SHIPMENT, shipment);
    }
    
    public void filterByPaymentWay(String paymentWay) {
        setFilter(SalesOrderLookupConfiguration.INOUT_PAYMENTWAY, paymentWay);
    }
    ...
    public void filterByIsFixOrder(String isFixOrder) {
        setFilter(SalesOrderLookupConfiguration.IN_IS_FIX_ORDER, isFixOrder);
    }
