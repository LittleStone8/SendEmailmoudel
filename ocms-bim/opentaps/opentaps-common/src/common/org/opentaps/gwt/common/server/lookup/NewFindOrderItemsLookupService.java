 ...
 */
public class NewFindOrderItemsLookupService extends EntityLookupService {

    private static final String MODULE = NewFindOrderItemsLookupService.class.getName();

    private OpentapsShoppingCart cart;
    
    private String productCatalogId;

    protected NewFindOrderItemsLookupService(InputProviderInterface provider, OpentapsShoppingCart cart) throws RepositoryException {
        super(provider, OrderItemsCartLookupConfiguration.LIST_OUT_FIELDS);
        this.cart = cart;
    }

    protected NewFindOrderItemsLookupService(InputProviderInterface provider, OpentapsShoppingCart cart, String productCatalogId) throws RepositoryException {
        this(provider, cart);
    ...
    public static String findOrderItemsCart(HttpServletRequest request, HttpServletResponse response) throws FoundationException {
        ...
        NewFindOrderItemsLookupService service = new NewFindOrderItemsLookupService(provider, cart);
    ...
    public static String getProductInfoForCart(HttpServletRequest request, HttpServletResponse response) throws FoundationException {
        ...
        NewFindOrderItemsLookupService service = new NewFindOrderItemsLookupService(provider, cart, productCatalogId);
