...
public final class UtilOrder {
    ...
    /*yz/20170607*/
    public static String getBillToCustomerPartyName_new(Delegator delegator, String orderId, boolean lastNameFirst) throws GenericEntityException {
        String partyId = getBillToCustomerPartyId(delegator, orderId);
        String partyName = null;
        if (UtilValidate.isNotEmpty(partyId)) {
            partyName = PartyHelper.getPartyName(delegator, partyId, lastNameFirst);
	...
	public static String findfeaturesByproductid(Delegator delegator, String productId) throws GenericEntityException {
