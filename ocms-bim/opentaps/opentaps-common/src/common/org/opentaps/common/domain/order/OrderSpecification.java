...
//		鏀粯鐘舵��
        PAYMENT(StatusItemConstants.OrderStatus.ORDER_PAYMENT),
//      杩愯緭鐘舵��
        SHIPPED(StatusItemConstants.OrderStatus.ORDER_SHIPPED),
        PACKED(StatusItemConstants.OrderStatus.ORDER_PACKED),
    ...
    public Boolean isShipped(Order order) {
        return OrderStatusEnum.SHIPPED.equals(order.getStatusId());
    }
    
    /** 鑷畾涔夋敮浠榹@inheritDoc} */
    public Boolean isPayment(Order order) {
        return OrderStatusEnum.PAYMENT.equals(order.getStatusId());
    }
