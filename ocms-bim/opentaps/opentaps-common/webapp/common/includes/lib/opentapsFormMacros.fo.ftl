...
<#escape x as x?xml>
    ...
    <fo:block> ${postalAddress.address1?if_exists},${postalAddress.city?if_exists} </fo:block>
   	<fo:block> ${postalAddress.countyGeoId?if_exists},${postalAddress.stateProvinceGeoId?if_exists}, ${postalAddress.countryGeoId?if_exists}  </fo:block>
