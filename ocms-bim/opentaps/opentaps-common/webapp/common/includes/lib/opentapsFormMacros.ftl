...
<#-- --    Display Macros    -- -->
<#-- -------------------------- -->
<#macro inputSelectInventoryFacility title name list default="" titleClass="tableheadtext" class="inputBox">
<tr>
<td class="titleCell"><span class="${titleClass}">${title}</span></td>
<td>
<select id='inventoryFacility' name='${name}' class="${class}">
 <#list list as facility>	
 	<#if facility.facilityId == default><#assign selected = "selected=\"selected\""><#else><#assign selected = ""></#if>
 		<option ${selected} value="${facility.facilityId}">
...
<#macro newPaginate name list="" rememberOrderBy=true rememberPage=true renderExcelButton=false params...>
