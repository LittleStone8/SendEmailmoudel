...
<#macro leftSectionHeader title extra="" titleId="" class="frameSectionHeader" titleClass="" style="">  
  <div class="left_section_titlebar">
  		<div class="titlebar_name">${title}</div>
  </div>
</#macro>
<#macro leftSection title extra="" innerStyle="" style="" class="left_section" headerClass="frameSectionHeader">
<div class="${class}" style="${style}">
  <@leftSectionHeader title=title extra=extra class=headerClass/>
  <div class="left_section_catalog" style="${innerStyle}">
    <#nested/>
  </div>
</div>
</#macro>
