             ...
             <fo:table-cell>
                <fo:block font-size="9pt">${organizationCompanyName}</fo:block>
                   <#if organizationPostalAddress?has_content>
                      ...
                      <#if organizationPostalAddress.address2?has_content><fo:block font-size="9pt">${organizationPostalAddress.countyGeoId?if_exists}</fo:block></#if>
                      <fo:block font-size="9pt">${organizationPostalAddress.city?if_exists}, ${stateProvinceAbbrv?if_exists} ${countryName?if_exists}</fo:block>
                   </#if>
             </fo:table-cell>
          </fo:table-row>
        <#if website?exists>
