...
<form name="findInventory" method="post" action="<@ofbizUrl>ViewFacilityInventoryByProduct</@ofbizUrl>" id="findInventory">
  ...
  <table class="twoColumnForm">
    <tr>
  	 ...
  	 <#if selectFacilityId??><#assign defaultFacilityId = selectFacilityId><#else><#assign defaultFacilityId = defaultInventoryFacilityId></#if>
  	 <@inputSelectInventoryFacility title="Inventory Facility" name="facilityIdTo" list=inventoryFacilitys default=defaultFacilityId />
    </tr>
    <tr>
