	...
	var nav_template ='<nav class="navbar">\
					        ...
					        <ul class="nav navbar-nav">\
								<% _.each(navInfoList, function(navInfo){  %>\
									<li><a href="<%- navInfo.linkUrl%>" title="<%- navInfo.name %>"><%- navInfo.name %></a></li>\
								<% }) %>\
					        </ul>\
							<ul class="nav navbar-nav navbar-right">\
								<li class="dropdown">\
									...
									<ul class="dropdown-menu">\
										...
										<li><a href="/catalog/control/ListVisualThemes" id="theme"><%- languageMap.commonVisualThemes %></a></li>\
									</ul>\
								</li>\
	...
	jQuery(document).ready(function($){
		 ...
		 $.ajax({
			  ...
			  success: function(jsonObj){
				    ...
				    jsonObj.userLoginId = jsonObj.userLoginId || "";
