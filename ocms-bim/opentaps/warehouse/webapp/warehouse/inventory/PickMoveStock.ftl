...
<@frameSection title=uiLabelMap.ProductQuickStockMove>
  <form method="post" action="<@ofbizUrl>processQuickStockMove</@ofbizUrl>" name='quickStockMove'>
    ...
    <table cellspacing="0" class="basic-table hover-bar">
      <tr class="header-row">
        <td>${uiLabelMap.ProductProduct}${uiLabelMap.MustFillIn}</td>
        <td>${uiLabelMap.ProductFromLocation}${uiLabelMap.MustFillIn}</td>
        <td>${uiLabelMap.ProductToLocation}${uiLabelMap.MustFillIn}</td>
        <td>${uiLabelMap.ProductMoveQuantity}${uiLabelMap.MustFillIn}</td>
        <td>&nbsp</td>
      </tr>
