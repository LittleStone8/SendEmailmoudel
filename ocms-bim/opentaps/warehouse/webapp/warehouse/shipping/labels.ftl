...
<table class="crmsfaListTable">
  ...
  <tr class="${tableRowClass(row_index)}">
    ...
    <@displayCell text=row.primaryOrderId />
    ...
    <@displayLinkCell href="labelsnew.pdf?orderId=${row.primaryOrderId}&shipmentId=${row.shipmentId}&shipmentRouteSegmentId=${row.shipmentRouteSegmentId}&shipmentPackageSeqId=${row.shipmentPackageSeqId}&amp;navigation=Y" text=uiLabelMap.ProductLabel />
    <#if pageSize != 0>
