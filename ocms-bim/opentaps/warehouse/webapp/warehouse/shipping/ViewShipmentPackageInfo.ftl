  ...
  <table width="100%" cellspacing="0" cellpadding="2" border="1">
    ...
    <#list shipmentPackageDatas as shipmentPackageData>
      ...
      <tr>
        ...
        <td><@display text="${uiLabelMap.ProductWeightUnit} :"/>Kilogram<!--  <#if weightUom?has_content><@display text=weightUom.get("description",locale)/><#else><@display text=shipmentPackage.weightUomId?if_exists/></#if>--></td>
      </tr>
