  ...
  <#if shipment?exists>
    <table border="0" cellpadding="2" cellspacing="0">
      ...
      <tr>
        ...
        <td><span class="tabletext">&nbsp;</span></td>
        <td width="80%" align="left"><span class="tabletext"><#if shipment.primaryOrderId?exists>${shipment.primaryOrderId }</#if></span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td width="80%" align="left">
          <span class="tabletext">
           ...
           <br> <span class="tableheadtext">${uiLabelMap.CommonFrom}:&nbsp;</span>${(fromPerson.firstName)?if_exists} ${(fromPerson.middleName)?if_exists} ${(fromPerson.lastName)?if_exists} ${(fromPartyGroup.groupName)?if_exists} [${shipment.partyIdFrom?if_exists}]
          </span>
        </td>
      </tr>
      ...
      <tr>
        ...
        <!--   <div class="tabletext"><span class="tableheadtext">${uiLabelMap.ProductOrigin}:&nbsp;</span>${shipment.originContactMechId?if_exists}&nbsp;<#if originPostalAddress?has_content>[${uiLabelMap.CommonTo} : ${originPostalAddress.toName?if_exists}, ${uiLabelMap.CommonAttn} : ${originPostalAddress.attnName?if_exists}, ${originPostalAddress.address1?if_exists}, ${originPostalAddress.address2?if_exists}, ${originPostalAddress.city?if_exists}, ${originPostalAddress.stateProvinceGeoId?if_exists}, ${originPostalAddress.postalCode?if_exists}, ${originPostalAddress.countryGeoId?if_exists}]</#if></div>
           -->
           <div class="tabletext"><span class="tableheadtext">${uiLabelMap.ProductDestination}:&nbsp;</span>${shipment.destinationContactMechId?if_exists}&nbsp;<#if destinationPostalAddress?has_content>[ ${destinationPostalAddress.address1?if_exists}, ${destinationPostalAddress.countyGeoId?if_exists}, ${destinationPostalAddress.city?if_exists}, ${destinationPostalAddress.stateProvinceGeoId?if_exists}, ${destinationPostalAddress.countryGeoId?if_exists}]</#if></div>
        </td>
      </tr>
   <!-- 
      <tr>
