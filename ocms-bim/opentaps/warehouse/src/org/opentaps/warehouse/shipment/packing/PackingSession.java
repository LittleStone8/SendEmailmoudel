...
public class PackingSession extends org.ofbiz.shipment.packing.PackingSession implements java.io.Serializable {
     ...
     */
	public static Map<String, Object> resettrackingcode(DispatchContext dctx, Map<String, ? extends Object> context) {
    ...
    public String getPackageTrackingCode_new(String packageSeqId) {
    	String ret="EGATEE";
    	SimpleDateFormat df = new SimpleDateFormat("yyMMdd");//设置日期格式
    	ret+=df.format(new Date());
    	long serialnumber=getDispatcher().getDelegator().getNextSeqIdLong("TrackingCode");
