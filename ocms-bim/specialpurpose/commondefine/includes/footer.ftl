...
<script type="text/javascript" src="/commondefine_js/bootstrap.min.js"></script>
...
<script src="/commondefine_js/FacnyTable/sample.js"></script>
        ...
        function getReceiveEvt(){
            jQuery.ajax({
                ...
                success: function(res){
                    if(res.resultCode == 1){
                        if(res.totalNum > 0){
                        	jQuery('.receiveContent').text(res.totalNum);
                        	jQuery('.receiveContent').css('display', 'inline-block');
                        }else{
                        	jQuery('.receiveContent').text('');
                        	jQuery('.receiveContent').css('display', 'none');
                        }
                    }
                }
             });
