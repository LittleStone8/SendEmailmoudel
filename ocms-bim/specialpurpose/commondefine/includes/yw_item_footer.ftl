...
<script type="text/javascript" src="/commondefine_js/JsBarcode.all.min.js"></script>
<script type="text/javascript" >
	...
	requirejs.config({
		...
		paths:{
			//dialog:'/commondefine_js/dialog/dialog-plus',
			bootstrapselect:'/commondefine_js/bootstrap-select',
			datatime:'/commondefine_js/Datetimepicker/bootstrap-datetimepicker',
			layData:'/commondefine_js/laydate.dev',
