define(['Zepto','Inherit','template','text!findLotHtml'],
	...
	var BaseView = new Inherit.Class({
		...
		initEvent:function(){
			var t=this;
			t.$form.on("click",".lot_close",function(){
				$(".right_arrow").attr('data-ids','productId').show();
				typeof t.options.onSelected == "function" && t.options.onSelected();
			})
