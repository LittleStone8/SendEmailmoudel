...
public class UtilDateTime {
    ...
    public static String timeStampToStringwww(TimeZone tz, Locale locale) {
    	return timeStampToStringwww(getTimestamp(System.currentTimeMillis()), null, tz, locale);
    ...
    public static String timeStampToStringwww(Timestamp stamp, String dateTimeFormat, TimeZone tz, Locale locale) {
        DateFormat dateFormat = toDateTimeFormat("dd/MM/yyyy HH:mm:ss", tz, locale);
        dateFormat.setTimeZone(tz);
        return dateFormat.format(stamp);
    }
