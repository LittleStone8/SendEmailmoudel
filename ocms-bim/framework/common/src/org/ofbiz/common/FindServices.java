...
public class FindServices {
    ...
    public static List<EntityCondition> createConditionList(Map<String, ? extends Object> parameters, List<ModelField> fieldList, Map<String, Object> queryStringMap, Delegator delegator, Map<String, ?> context, List<String> dateTimeFields, TimeZone timeZone, Locale locale) {
        ...
        for (Map.Entry<String, ? extends Object> entry : parameters.entrySet()) {
            ...
            if (dateTimeFields.contains(fieldName)&&false) {
                ...
                try {
                    ...
                    dateObj = df.parse(fieldValue.toString());
    ...
    /*yzl20170610*/
    public static Map productfeaturesFind(DispatchContext dctx, Map<String, ?> context) {
    	 Map<String, GenericValue>  locale = (Map<String, GenericValue> ) context.get("queryStringMap");
    	 Delegator delegator = dctx.getDelegator();
		...
		for (Map.Entry<String, GenericValue> entry : locale.entrySet()) {
			GenericValue temp = (GenericValue) entry.getValue();
        ...
        Map<String, Object> results = ServiceUtil.returnSuccess();
        results.put("retStringMap", locale);
        return results;
    }
    /**
     * executeFind
