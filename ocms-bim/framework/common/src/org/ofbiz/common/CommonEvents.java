...
public class CommonEvents {
    ...
    public static String setSessionTimeZone(HttpServletRequest request, HttpServletResponse response) {
        ...
        if(request.getRequestURL().toString().contains("warehouse/control/setSessionTimeZone"))
        	return "newFindInventoryItem";
        if(request.getRequestURL().toString().contains("ordermgr/control/setSessionTimeZone"))
        	return "myOrders";
        return "success";
    }
