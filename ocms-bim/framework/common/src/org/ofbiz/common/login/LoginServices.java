...
public class LoginServices {
    ...
    public static Map<String, Object> createUserLogin(DispatchContext ctx, Map<String, ?> context) {
        ...
        //20170713创建时根据配置文件中的地区去配置相应的时区
        Map<String, Object> retmap = getSystemSettings(ctx, context);
        String lasttimezone=null;
        String countryId = (String)retmap.get("countryId");
        
        
        if("TZA".equals(countryId)||"UGA".equals(countryId))
        {
        	lasttimezone="Africa/Kampala";
        }
        else 
        {
        	lasttimezone="Africa/Accra";
        }
        userLoginToCreate.set("lastTimeZone", lasttimezone);
